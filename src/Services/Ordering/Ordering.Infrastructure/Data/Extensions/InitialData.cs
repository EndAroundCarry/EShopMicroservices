namespace Ordering.Infrastructure.Data.Extensions
{
    internal class InitialData
    {
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Adress.Of("mehmet", "ozkaya", "mehmet@gmail.com", "Bahcelievler No:4", "Turkey", "Istanbul", "38050");
                var address2 = Adress.Of("john", "doe", "john@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");
